...
#if UNITY_EDITOR // Only in Editor Mode
using UnityEditor;

public class OperatorWindow : EditorWindow {
...
//	private int MainCameraTargetDisplay = 0;
	...
	static OperatorWindow window;

	public static OperatorWindow Instance{
		get{
			return window;
		}
	}
...
////		PupilTools.Settings.currentCamera.Render();
//
...
//			Debug.Log ("Time to close the window");
//			window.Close ();
//		}
	}
